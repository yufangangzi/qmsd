            ...
            <li>
                <a>
                    ...
                    <div  class="poemNews">
                            ...
                            <span><i class="icon iconfont icon-comment"></i>5632</span>
...
<style scoped lang="less">
    li a{width:100%;padding: 0.38rem 0.3rem 0.25rem;background: #fff;border-top: 1px solid #f5f5f5;;display: flex;align-items: flex-start;font-size: 0;
        div.more{font-size: 0.2rem;color: #a4a4a4;height:0.72rem;width: 0.72rem;text-align: center;line-height: 0.72rem;}

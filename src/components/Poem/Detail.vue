...
[00:04.48]那榆荫下的一潭，
            ...
            <!--<div class="aplayer-music"><span class="aplayer-title">' + this.music.title + '</span><span class="aplayer-author"> - (＞﹏＜)加载中,好累的说...</span></div>-->
            <!--<div class="aplayer-lrc"><div class="aplayer-lrc-contents" style="transform: translateY(0);"></div></div>-->
            <!--</div>-->
            <!--<div class="aplayer-controller">-->
            <!--<div class="aplayer-bar-wrap">-->
                <!--<div class="aplayer-bar"><div class="aplayer-loaded" style="width: 0"></div><div class="aplayer-played" style="width: 0"><span class="aplayer-thumb"></span></div></div>-->
                <!--</div><div class="aplayer-time">-->
                <!--<span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">(oﾟ▽ﾟ)</span>' +'<div class="aplayer-volume-wrap"><i class="demo-icon aplayer-icon-volume-down"></i>-->
                    <!--<div class="aplayer-volume-bar-wrap"><div class="aplayer-volume-bar"><div class="aplayer-volume" style="height: 80%"></div></div></div>-->
                    <!--</div>-->
                <!--</div>-->
                <!--<a class="aplayer-con"><div class="aplayer-pic">-->
                <!--<img src="../../assets/avatar.jpg">-->
                <!--<div class="aplayer-button aplayer-pause aplayer-hide"><i class="icon iconfont icon-pause"></i></div>-->
                <!--<div class="aplayer-button aplayer-play"><i class="icon iconfont icon-play"></i></div>-->
                <!--</div>-->
            <!--</a>-->
            <!--</div>-->
        </div>
...
<script>
    ...
    methods: {
      ...
      Aplayer(){
        axios.get('http://219.238.250.44:8080/api/v1/user/recite/recites').then((res)=>{
         console.log(res)
        });
        let ap3 = new APlayer({
          ...
          music: {
            title: '再别康桥',
            author: '徐志摩',
            url: 'http://sc1.111ttt.cn/2015/1/03/24/96241344547.mp3',
